...
export enum ApplictionURLS{
    GoogleApp= "https://www.google.com/",
    VacationAPP = "https://vacationsdirect.com"
}

export enum AssertionData{
    GoogleTitle = "Google",
    ...
    SortingOrderDescending = "desc",
    PaginationHotelCountPage1 = "1 to 25",
    PaginationHotelCountPage2 = "26 to 50"
}
